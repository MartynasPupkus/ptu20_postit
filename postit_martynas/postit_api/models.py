...
class CommentLike(UserModel):
    comment = models.ForeignKey(Comment, verbose_name=_("comment like"), on_delete=models.CASCADE, related_name = 'likes')
    ...
    def __str__(self) -> str:
        return "{} {} {}".format(self.comment, _('liked by'), self.user,)
